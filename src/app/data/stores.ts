...
export const STORES: RecommendableStore[] = [
  ...
  },
  {
    ...
    floor: "1F-A12",
    category: "时尚奢品",
    categoryLabel: "高级成衣 / 皮具 / 香水美妆",
    scenes: ["送礼挑选", "纪念日", "自用奢养", "商务送礼"],
    audience: ["情侣", "商务送礼", "高端用户"],
    priceRange: "客单900–70,000元起",
    priceLevel: 4,
    tags: ["Classic Flap新色", "22 Bag限定", "建议提前1天预约"],
    highlight: "Classic Flap 新色到店、22 Bag 限定粗花呢款,经典优雅法式奢品。",
    recommendItems: ["Classic Flap", "22 Bag", "2.55 Reissue", "香水"],
    tip: "建议提前1天预约,黑卡享新品优先预览。",
    saBooking: true,
  ...
  },
  {
    ...
    floor: "1F-C01",
    category: "时尚奢品",
    categoryLabel: "皮具 / 成衣 / 配饰 / 腕表",
    scenes: ["送礼挑选", "纪念日", "自用升级"],
    audience: ["情侣", "高端用户", "商务送礼"],
    priceRange: "客单3,000–60,000元起",
    priceLevel: 4,
    tags: ["Speedy新配色", "Capucines迷你", "旅行精神"],
    highlight: "Speedy Bandoulière 20 新配色、Capucines 迷你款,摩登经典旅行精神。",
    recommendItems: ["Speedy Bandoulière 20", "Neverfull", "Capucines"],
    tip: "支持预约,VIP 享新品预约券。",
    saBooking: true,
    image: "/checkin-coffee.jpg",
  },
  {
    ...
    scenes: ["送礼挑选", "纪念日", "约会"],
    audience: ["情侣", "高端用户"],
    priceRange: "客单2,500–80,000元起",
    priceLevel: 4,
    tags: ["Lady Dior微型", "Saddle回归", "美妆满3000减300"],
    highlight: "Lady Dior 微型款、Saddle 马鞍包回归,浪漫优雅女性力量。",
    recommendItems: ["Lady Dior", "Saddle", "Book Tote", "香水"],
    tip: "美妆与精品券满3000减300,支持预约。",
    saBooking: true,
    image: "/checkin-coffee.jpg",
  },
  {
    ...
    floor: "1F-E08",
    category: "时尚奢品",
    categoryLabel: "皮具 / 成衣 / 香水美妆",
    scenes: ["送礼挑选", "纪念日", "自用升级"],
    audience: ["情侣", "高端用户", "年轻情侣"],
    priceRange: "客单1,800–40,000元起",
    priceLevel: 4,
    tags: ["Jackie 1961新色", "Horsebit 1955", "GG Marmont"],
    highlight: "Jackie 1961 新色、Horsebit 1955 迷你款,意式复古先锋。",
    recommendItems: ["Jackie 1961", "Horsebit 1955", "GG Marmont"],
    tip: "支持预约,当季精选券可用。",
    saBooking: true,
    image: "/checkin-coffee.jpg",
  },
